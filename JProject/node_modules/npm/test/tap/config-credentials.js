...
test("set with old-style.css credentials", function (t) {
  npmconf.load(common.builtin, function (er, conf) {
    t.ifError(er, "configuration loaded")
...
test("clear with old-style.css credentials", function (t) {
  npmconf.load(common.builtin, function (er, conf) {
    t.ifError(er, "configuration loaded")
...
test("get old-style.css credentials for default registry", function (t) {
  npmconf.load(common.builtin, function (er, conf) {
